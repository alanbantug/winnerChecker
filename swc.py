...
class Application(Frame):
    ...
    def __init__(self, master):
        ...
        self.mainLabel = Label(self.main_container, text="SUPERLOTTO CHECKER", style="M.TLabel" )
        self.subLabelA = Label(self.main_container, text="Checks a Super Lotto combination if it is a winner based on a selected text file ", style="S.TLabel" )
