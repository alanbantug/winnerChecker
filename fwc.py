...
class Application(Frame):
    ...
    def __init__(self, master):
        ...
        self.mainLabel = Label(self.main_container, text="FANTASY FIVE WINNER CHECKER", style="M.TLabel" )
        ...
        self.dataDisplay = LabelFrame(self.main_container, text=' Combinations ', style="O.TLabelframe")
        self.scroller = Scrollbar(self.dataDisplay, orient=VERTICAL)
        self.dataSelect = Listbox(self.dataDisplay, yscrollcommand=self.scroller.set)
        
        self.dataOpt = LabelFrame(self.main_container, text=' Data File Options ', style="O.TLabelframe")
        self.dataSource = Button(self.dataOpt, text="Data File", style="B.TButton", command=self.setSource)
        ...
        self.submit = Button(self.main_container, text="CHECK", style="B.TButton", command=self.startProcess)
        self.reset = Button(self.main_container, text="RESET", style="B.TButton", command=self.restartProcess)
        ...
        self.dataSelect.grid(row=0, column=0, padx=5, pady=5, sticky='NSEW')
        self.scroller.grid(row=0, column=2, sticky='NSEW')
        self.dataDisplay.grid(row=5, column=0, columnspan=3, rowspan=5, padx=5, pady=5, sticky='NSEW')

        self.dataSource.grid(row=0, column=0, columnspan=1, padx=5, pady=5, sticky='NSEW')
        self.dataLabel.grid(row=0, column=1, columnspan=2, padx=5, pady=5, sticky='NSEW')
        self.dataOpt.grid(row=10, column=0, columnspan=3, padx=5, pady=5, sticky='NSEW')

        self.match3.grid(row=0, column=0, padx=5, pady=5, sticky='W')
        self.match4.grid(row=0, column=1, padx=5, pady=5, sticky='W')
        self.match5.grid(row=0, column=2, padx=5, pady=5, sticky='W')
        self.filterOpt.grid(row=11, column=0, columnspan=3, padx=5, pady=5, sticky='NSEW')
        
        self.sep_b.grid(row=12, column=0, columnspan=3, padx=5, pady=5, sticky='NSEW')

        self.submit.grid(row=13, column=0, columnspan=1, padx=5, pady=0, sticky='NSEW')
        self.reset.grid(row=13, column=1, padx=5, pady=0, sticky='NSEW')
        self.exit.grid(row=13, column=2, padx=5, pady=0, sticky='NSEW')
        self.sep_d.grid(row=14, column=0, columnspan=3, padx=5, pady=5, sticky='NSEW')
